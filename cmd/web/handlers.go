...
import (
	...
	"snippetbox.natenine.com/internal/validator"
...
func (app *application) userSignUpPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Name), "name", "Name can not be blank")
	form.CheckField(validator.MinChars(form.Name, 4), "name", "Name too short")
	form.CheckField(validator.NotBlank(form.Email), "email", "Email can not be blank")
	...
	// If there is no error show the flash message
